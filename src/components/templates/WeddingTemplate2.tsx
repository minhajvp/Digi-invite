...
import { MapPin, CalendarHeart, Heart } from 'lucide-react';

interface Props {
  data: Partial<IInvitation>;
}

export default function WeddingTemplate2({ data }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#fcf9f6] text-slate-800 font-sans flex flex-col items-center relative overflow-x-hidden">
      ...
      <div className="z-10 w-full max-w-4xl px-6 py-12 md:py-24 flex flex-col items-center relative bg-[#fcf9f6]/80 backdrop-blur-md rounded-t-[4rem] shadow-[0_-20px_40px_rgba(0,0,0,0.03)] -mt-20">
        ...
        >
          <h2 className="font-cinzel text-2xl text-rose-900 mb-12 tracking-widest">
            The Families
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              {brideAddress && <p className="text-sm font-cinzel text-slate-400 mt-4 leading-relaxed break-words">{brideAddress}</p>}
            </div>
            ...
            <div>
              ...
              {groomAddress && <p className="text-sm font-cinzel text-slate-400 mt-4 leading-relaxed break-words">{groomAddress}</p>}
            </div>
          </div>
          
          {familyAddress && (
            <div className="mt-16 pt-8 border-t border-rose-900/10">
              <p className="text-sm font-light text-slate-500 leading-relaxed max-w-md mx-auto">
                {familyAddress}
              </p>
            </div>
          )}
